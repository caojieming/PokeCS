...
//tell window to place each new component under the previous ones
    ...
    move1 = new JButton("" + playerPok.getMove1().getName());
    move1.setActionCommand("Move1");
    buttonPanel.add(move1);
    move2 = new JButton("" + playerPok.getMove2().getName());
    ...
    move3 = new JButton("" + playerPok.getMove3().getName());
    buttonPanel.add(move3);  
    move3.setActionCommand("Move3");
    move4 = new JButton("" + playerPok.getMove4().getName());
  ...
  public void run()
  {
    ...
    while (true)
    {
      ...
      if(elapsed > 4120) //Pokeball position
      {
        ...
        move1.setText(playerPok.getMove1().getName());
        move2.setText(playerPok.getMove2().getName());
        move3.setText(playerPok.getMove3().getName());
        move4.setText(playerPok.getMove4().getName());
    }
