...
public class SelectionScreen implements ActionListener
{
  ...
  public SelectionScreen()
  {
    ...
    for (int i = 0; i < 6; i++)
    {
      ...
      label.setIcon(new ImageIcon(getClass().getResource("?.gif")));
    ...
    String[][] pokemonNames = {
      ...
      {"Rapidash", "Meganium", "Espeon", "Magikarp", "Gyrados"},
      {"Furret", "Charizard", "Sceptile", "Blastoise", "Snorlax"}};
    ...
    for (int x = 0; x < 3; x++)
     ...
     JLabel label = new JLabel("pick a weirdo for your team");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    else
    {
     ...
     for (int i = 0; i < 6; i++)
       selectedPokemon.get(i).setIcon(new ImageIcon(getClass().getResource("?.gif")));
     int numReAdded = 0;
     pokNames = new ArrayList<String>();
     for (int x = 0; x < 3; x++)
     {
